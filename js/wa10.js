// Note: Story is generated using AI
...
const storyText = "It was a sunny day, with a temperature of :temperature: degrees, so :insertx: decided to go on an adventure. They packed their bags and headed to :inserty:. Along the way, they encountered many exciting things and met new friends. At one point, they even had a picnic with :insertz:. It was a memorable journey, and they returned home with wonderful memories. :insertx: couldn't wait to share their stories with their other stuffed animal friends.";
...
function result() {
    ...
    if(document.getElementById("uk").checked) {
      ...
      newStory = newStory.replace(/:temperature:/g, 94);
    }
